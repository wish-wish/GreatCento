...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIPolygonExt : UIPrimitiveBase
    {
        ...
        public void DrawPolygonExt(int _sides)
        {
            sides = _sides;
        ...
        public void DrawPolygonExt(int _sides, float[] _VerticesDistances)
        {
            sides = _sides;
        ...
        public void DrawPolygonExt(int _sides, float[] _VerticesDistances, float _rotation)
        {
            sides = _sides;
            VerticesDistances = _VerticesDistances;
            rotation = _rotation;
