...
#include "..\..\uRaymarching\Shaders\Include/Common.cginc"
...
Pass
{
    ...
    CGPROGRAM
    #include "..\..\uRaymarching\Shaders\Include/ForwardBaseStandard.cginc"
    #pragma target 3.0
    #pragma vertex Vert
...
Pass
{
    ...
    CGPROGRAM
    #include "..\..\uRaymarching\Shaders\Include/ForwardAddStandard.cginc"
    #pragma target 3.0
    #pragma vertex Vert
    #pragma fragment Frag
    #pragma multi_compile_instancing
...
Pass
{
    ...
    CGPROGRAM
    #include "..\..\uRaymarching\Shaders\Include/ShadowCaster.cginc"
    #pragma target 3.0
    #pragma vertex Vert
    #pragma fragment Frag
